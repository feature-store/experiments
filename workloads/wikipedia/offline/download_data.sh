...
aws s3 sync s3://feature-store-datasets/wikipedia/diffs diffs; 
...
aws s3 sync s3://feature-store-datasets/wikipedia/embeddings embeddings;

## download raw api data 
#mkdir -p ${data_dir}/recentchanges; 
#mkdir -p ${data_dir}/doc_xml; 
#aws s3 sync s3://feature-store-datasets/wikipedia/recentchanges recentchanges;
#aws s3 sync s3://feature-store-datasets/wikipedia/doc_xml doc_xml;
